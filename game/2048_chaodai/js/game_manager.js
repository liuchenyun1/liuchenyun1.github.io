  ...
  traversals.x.forEach(function (x) {
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        if (next && next.true_value === tile.true_value && !next.mergedFrom) {
          var merged = new Tile(positions.next, tile.true_value * 2);
          ...
          // Update the score
          self.score += merged.true_value;

          // The mighty 2048 tile
          if (merged.true_value === 2048) self.won = true;
        } else {
    ...
    for (var y = 0; y < this.size; y++) {
      ...
      if (tile) {
        for (var direction = 0; direction < 4; direction++) {
          ...
          if (other && other.true_value === tile.true_value) {
